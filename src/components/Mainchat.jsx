...
const Mainchat = () => {
    ...
    const stompConnect = () => {
        console.log('connect')
        let sock = new SockJS(server + '/ws-seesaw')
        console.log(sock)
    ...
    const sendPublicMessage = () => {
        ...
        if (!userData.message) {
            ...
            try {
                ...
                stompClient.send("/pub/mainchat", {}, JSON.stringify(chatMessage))
    ...
    useEffect(() => {
        ...
        axios.get('http://3.38.104.97/mainchat/get/main')
            .then((res) => {
    ...
    const onConnected = () => {
        ...
        try {
            ...
            stompClient.send("/pub/mainchat", {}, JSON.stringify(user_join));
            stompClient.subscribe("/topic/mainchat", onPublicMessageReceived);
            // if (chatScroll !== true) {
            //   scroll();
            //   setChatScroll(true);
            // }
